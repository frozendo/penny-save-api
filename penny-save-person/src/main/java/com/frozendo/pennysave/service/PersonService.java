...
public class PersonService {
    ...
    public Person create(Person person) {
        ...
        triggerPersonEvent(savedEntity, PersonActionEnum.CREATED);
        return savedEntity;
    }
    ...
    private void validatePerson(Person person) {
        ...
        if (personExist.isPresent()) {
            throw new BusinessException(PersonBusinessMessageEnum.EMAIL_DUPLICATED);
        }
    }

    private void triggerPersonEvent(Person person, PersonActionEnum operation) {
